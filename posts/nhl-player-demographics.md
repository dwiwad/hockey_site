...
## Nationality: From pure Canada to North America something.

Paragraph 4: Nationality — From Canadian Stronghold to Global Mix
Main Point: Canada once dominated with over 95% of NHL players; now it's under 50%.

Major Trend: U.S. has surged, nearing parity. Scandinavian and European nations make up a stable, growing minority.

Historical Pivot: Expansion era (70s–90s) and the fall of the USSR opened the door for international influx.

Modern Lens: The NHL is now truly North American, with global representation that adds skill diversity.
...
Paragraph 1: Age — Steady in a Shifting Game
Main Point: Despite seismic shifts in how hockey is played, the average age of NHL players has stayed between 24 and 28 for over a century.

Analysis Opportunity: Briefly explore why—development pipelines, peak performance windows, and roster turnover may act as natural constraints.

Implication: Hockey remains a sport dominated by prime-age athletes, regardless of era.
...
Paragraph 3: Weight — Rising, Peaking, Then Tapering
...
Conclusion: What We’ve Learned from the NHL's Shifting Profile
